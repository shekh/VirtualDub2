 ...
 */
static __inline int check_size(TiffEncoderContext *s, uint64_t need)
{
...
int tiff_encode_frame(AVCodecContext *avctx, AVPacket *pkt,
...
int tiff_encode_init(AVCodecContext *avctx, int compr)
{
    ...
    avctx->coded_frame = av_mallocz(sizeof(AVFrame));
